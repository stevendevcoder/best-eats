...
function Navbar() {
  ...
  return (
    <div className='w-full mx-auto flex justify-between items-center p-4'>
      ...
      <div className={navbar ? 'fixed top-0 left-0 w-[300px] h-screen bg-white z-10 duration-300' : 'fixed top-0 left-[-100%] w-[300px] h-screen bg-white z-10 duration-300' }>
        <AiOutlineClose 
          size={30} 
        ...
        <nav>
            <ul className='flex flex-col p-4 text-gray-800'>
                ...
                <li className='text-xl p-4 flex'><MdFavorite size={25} className='mr-4' /> Favorites</li>
                ...
                <li className='text-xl p-4 flex'><BsFillSaveFill size={25} className='mr-4' /> Best Ones</li>
