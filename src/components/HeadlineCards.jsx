...
function HeadlineCards() {
  return (
    <div className='max-w-[1540px] mx-auto p-4 py-12 grid md:grid-cols-3 gap-6'>
      <div className='rounded-xl relative' data-aos='fade-right'>
        <div className='absolute w-full h-full bg-black/50 rounded-xl text-white'>
          <p className='font-bold text-2xl px-2 pt-4'>Sun's Out, BOGO's Out</p>
          <p className='px-2'>Through 8/26</p>
          <button className='border-white bg-white text-black mx-2 absoulte bottom-4'>Order Now</button>
        </div>
      ...
      <div className='rounded-xl relative' data-aos='fade-up'>
        <div className='absolute w-full h-full bg-black/50 rounded-xl text-white'>
          <p className='font-bold text-2xl px-2 pt-4'>New Restaurants</p>
          <p className='px-2'>Added Daily</p>
          <button className='border-white bg-white text-black mx-2 absoulte -4'>Order Now</button>
        </div>
      ...
      <div className='rounded-xl relative' data-aos='fade-left'>
        <div className='absolute w-full h-full bg-black/50 rounded-xl text-white'>
